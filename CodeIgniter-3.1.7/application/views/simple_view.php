            ...
            <div class="container">
                ...
                <div id="navbar" class="collapse navbar-collapse">  <!-- Full-width menu code -->
                    <ul class="nav navbar-nav">
                        <li class="active"><a href="https://in-info-web4.informatics.iupui.edu/~brownrob/N413/CodeIgniter-3.1.7/index.php/simpleview/">View One</a></li>
                        <li><a href="https://in-info-web4.informatics.iupui.edu/~brownrob/N413/CodeIgniter-3.1.7/index.php/simpleview/bs">View Two</a></li>
                    </ul>
